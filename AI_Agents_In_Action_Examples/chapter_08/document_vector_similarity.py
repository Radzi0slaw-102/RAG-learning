...
# Two key formulas:
# - TF: [how many times have word appeared in document] / [total number of words in document]
# - IDF: log( [total number of documents] / [in how many documents have given word appeared] )
# Finally: TF-IDF = TF * IDF
# It's rather simple, even naive, but good starting point
vectorizer = TfidfVectorizer()
X = vectorizer.fit_transform(documents)

# Calculating Cosine Similarity
# Varying from -1 for opposite vectors, through 0 for orthogonal vectors, ending on 1 for identical vectors
# Output - two-dimensional array (matrix), where:
# - first index is the document index
# - second index is index of the document being "paired"
